...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if 1==1 then
        ...
        local KeySystem = KeyLibrary.new(Settings.KeySettings.Application or "Oops")
		...
		if isfile(RayfieldFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension) then
            Key__=readfile(RayfieldFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension)
            if KeySystem:verifyKey(Key__) then
                KeyFound = true
                FoundKey = Key__
            end
		end
